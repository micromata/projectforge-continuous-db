...
public class DatabaseSupport
{
  ...
  private static DatabaseDialect defaultDialect;

  private final DatabaseDialect dialect;

  public static void setDefaultDialect(DatabaseDialect dialect)
  {
  ...
  public DatabaseSupport()
  {
    if (defaultDialect == null) {
      throw new IllegalStateException("Oups, no default dialect given, please call setDefaultDialect(DatabaseDialect) before usage.");
    }
